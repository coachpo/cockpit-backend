...
// (e.g., codex-api-key.models[]). These models
...
//
// Suffix Priority: When the model name includes a thinking suffix (e.g., "gpt-5-codex(8192)"),
...
//   - model: Model name, optionally with thinking suffix (e.g., "gpt-5-codex(16384)")
//   - fromFormat: Source request format (e.g., openai, codex)
//   - toFormat: Target provider format for the request body (openai, codex)
...
//	result, err := thinking.ApplyThinking(body, "gpt-5-codex(8192)", "codex", "codex", "codex")
//
//	// Without suffix - uses body config
//	result, err := thinking.ApplyThinking(body, "gpt-5-codex", "codex", "codex", "codex")
