...
const (
	latestReleaseURL       = "https://api.github.com/repos/coachpo/cockpit/releases/latest"
	latestReleaseUserAgent = "Cockpit"
)
...
func (h *Handler) PutConfigYAML(c *gin.Context) {
	...
	if h.configSaver == nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "write_failed", "message": nacos.ErrStaticMode.Error()})
		return
	}
	if err = h.configSaver(&cfg); err != nil {
